...
public class RecipeBootStrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public RecipeBootStrap(CategoryRepository categoryRepository, UniteOfMeasureRepository uniteOfMeasureRepository, RecipeRepository recipeRepository) {
    ...
    private List<Recipe> getRecipes() {
        ...
        Optional<UnitOfMeasure> eachOptionalUnitOfMeasure = uniteOfMeasureRepository.findByDescription("Each");
        if (!eachOptionalUnitOfMeasure.isPresent()) {
            throw new RuntimeException("Expected UOM not found!!");
        }
        Optional<UnitOfMeasure> tableSpoon = uniteOfMeasureRepository.findByDescription("Tablespoon");
        if (!tableSpoon.isPresent()) {
            throw new RuntimeException("Expected UOM not found!!");
        }
        Optional<UnitOfMeasure> teaSpoon = uniteOfMeasureRepository.findByDescription("Teaspoon");
        if (!teaSpoon.isPresent()) {
            throw new RuntimeException("Expected UOM not found!!");
        }
        Optional<UnitOfMeasure> dash = uniteOfMeasureRepository.findByDescription("Dash");
        if (!dash.isPresent()) {
            throw new RuntimeException("Expected UOM not found!!");
        }
        Optional<UnitOfMeasure> pint = uniteOfMeasureRepository.findByDescription("Pinch");
        if (!pint.isPresent()) {
            throw new RuntimeException("Expected UOM not found!!");
        }
        Optional<UnitOfMeasure> cups = uniteOfMeasureRepository.findByDescription("Cup");
        if (!cups.isPresent()) {
            throw new RuntimeException("Expected UOM not found!!");
        }
        UnitOfMeasure each = eachOptionalUnitOfMeasure.get();
        ...
        UnitOfMeasure cupsUOM = cups.get();
...
//        tacoNotes.setRecipe(tacosRecipe);
    ...
    public UniteOfMeasureRepository getUniteOfMeasureRepository() {
        return uniteOfMeasureRepository;
    }
